...
use Tobento\Service\Upload\ImageProcessor as BaseImageProcessor;

/**
 * ImageProcessor with logging support.
 *
 * Wraps the base upload image processor and integrates with
