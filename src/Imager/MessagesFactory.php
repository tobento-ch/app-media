...
namespace Tobento\App\Media\Imager;
...
/**
 * MessagesFactory for Imager integration.
 *
 * Extends the base Imager messages factory and, if no modifiers
 * are provided, attempts to reuse the application's messages
 * factory (MessagesFactoryInterface) so that Imager messages
 * benefit from the same translation and modifiers pipeline.
 */
