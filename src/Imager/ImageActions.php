...
use Tobento\Service\Imager\ImageActions as BaseImageActions;

/**
 * ImageActions with logging support.
 *
 * Wraps the base imager image actions and integrates with
 * the app-logging system via LoggerTrait.
 */
class ImageActions extends BaseImageActions
{
    use LoggerTrait;
