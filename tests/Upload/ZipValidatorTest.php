...
class ZipValidatorTest extends TestCase
{
    ...
    {
        $this->assertInstanceof(ValidatorInterface::class, new ZipValidator());
    }
    
    public function testSupportsExtensionsMethod()
    {
        $this->assertSame(['zip'], new ZipValidator()->supportsExtensions());
    }
    ...
    public function testValidZipPasses()
    {
        ...
        $validator = new ZipValidator(allowedExtensions: ['zip']);
