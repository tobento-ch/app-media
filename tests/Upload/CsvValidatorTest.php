...
class CsvValidatorTest extends TestCase
{
    ...
    {
        $this->assertInstanceof(ValidatorInterface::class, new CsvValidator());
    }
    
    public function testSupportsExtensionsMethod()
    {
        $this->assertSame(['csv'], new CsvValidator()->supportsExtensions());
    }

    public function testAcceptsCsvMimeTypes()
    {
        $validator = new CsvValidator(allowedExtensions: ['csv']);
